  ...
  return (
    <form className="w-full flex flex-col mt-6" onSubmit={createNewHabit}>
      ...
      { availableWeekDays.map((weekDay, index) => (
        <div key={weekDay} className='mt-3 flex flex-col gap-3'>
          <Checkbox.Root 
      ...
      <button type="submit" className="mt-6 rounded-lg p-4 flex items-center justify-center gap-3 font-semibold bg-green-600 hover:bg-green-500 transition-colors focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 focus:ring-zinc-900">
